...
fn verify_f64_is_negative_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be negative
   but was: 0.0
  expected: < 0
"]
    );
...
fn verify_f64_is_not_negative_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be not negative
   but was: -0.001
  expected: >= 0
"]
    );
...
fn verify_f64_is_positive_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be positive
   but was: 0.0
  expected: > 0
"]
    );
...
fn verify_f64_is_not_positive_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be not positive
   but was: 0.001
  expected: <= 0
"]
    );
...
fn verify_f64_is_zero_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be zero
   but was: 1.0
  expected: 0.0
"]
    );
...
fn verify_f64_is_one_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be one
   but was: 0.0
  expected: 1.0
"]
    );
...
fn verify_f64_is_finite_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be finite
   but was: -inf
...
fn verify_f64_is_infinite_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be infinite
   but was: 0.0
...
fn verify_f64_is_a_number_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be a number
   but was: NaN
  expected: a number
"]
    );
...
fn verify_f32_is_not_a_number_fails() {
    ...
    assert_eq!(
        failures,
        &[r"expected some_number to be not a number
   but was: 0.0
  expected: NaN
"]
    );
...
mod cmp {
    ...
    fn verify_f32_is_close_to_another_f32_within_default_margin_fails() {
        ...
        assert_eq!(
            failures,
            &[r"expected tau / 2 to be close to 3.15
...
"]
    ...
    fn verify_f32_is_not_close_to_another_f32_within_default_margin_fails() {
        ...
        assert_eq!(
            failures,
            &[r"expected tau / 2 to be not close to 3.14
  within a margin of epsilon=4.7683716e-7 and ulps=4
   but was: 3.14
  expected: 3.14
"]
